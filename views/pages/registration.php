...
$eyeIcons = '<svg xmlns="http://www.w3.org/2000/svg" height="1em" class="eye-icon show-flex toggle-password" viewBox="0 0 640 512">
                            ...
                            32c-68.2 0-125 26.3-169.3 60.8L38.8 5.1zM223.1 149.5C248.6 126.2 282.7 112 320 112c79.5 0
                            144 64.5 144 144c0 24.9-6.3 48.3-17.4 68.7L408 294.5c8.4-19.3 10.6-41.4
                            4.8-63.3c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3
                            20.3c0 10.2-2.4 19.8-6.6 28.3l-90.3-70.8zM373 389.9c-16.4 6.5-34.3 10.1-53 10.1c-79.5
                            0-144-64.5-144-144c0-6.9 .5-13.6 1.4-20.2L83.1 161.5C60.3 191.2 44 220.8 34.5 243.7c-3.3
             ...
             <svg xmlns="http://www.w3.org/2000/svg" height="1em" class="eye-icon hide toggle-password" viewBox="0 0 576 512">
                            ...
                            7.4c.3 6.9 1.3 13.8 3.2 20.7c13.7 51.2 66.4 81.6 117.6 67.9s81.6-66.4
                            67.9-117.6c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2
                            3.3 20.3z"/>
                        </svg>';
?>
        ...
        <div class="registration-container">
            ...
            <div id="signin" class="tab-content show-flex">
                <form class="signin-form" action="/signin" method="post">
                    ...
                    <div class="submit-group">
                        <button id="signin-btn" class="btn-primary" type="submit">Sign in</button>
                        <button class="btn-error cancel-btn">Cancel</button>
                    </div>
                </form>
            </div>
